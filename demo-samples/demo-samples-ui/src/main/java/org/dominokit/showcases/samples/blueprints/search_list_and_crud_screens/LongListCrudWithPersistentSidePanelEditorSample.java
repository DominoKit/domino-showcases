...
import org.dominokit.showcases.samples.blueprints.crud.CrudBlueprintView;
...
public final class LongListCrudWithPersistentSidePanelEditorSample {
  ...
  public static CrudBlueprintView create() {
    return CrudBlueprintView.longListWithSideEditor();
  }
}
