  ...
  private void addMenuItems() {
    menu
        ...
        .appendChild(TreeItem.create(Icons.view_dashboard(), "Blueprints")
            .apply(addToggleIcon())
            .appendChild(TreeItem.create("Application foundations and navigation")
                .apply(addToggleIcon())
.appendChild(makeSubMenu("Shell with persistent navigation", "blueprints/application-foundations-and-navigation/shell-with-persistent-navigation"))
                .appendChild(makeSubMenu("Shell with contextual secondary navigation", "blueprints/application-foundations-and-navigation/shell-with-contextual-secondary-navigation"))
                .appendChild(makeSubMenu("Workspace with resizable navigation pane", "blueprints/application-foundations-and-navigation/workspace-with-resizable-navigation-pane"))
                .appendChild(makeSubMenu("Breadcrumb and back-stack workspace", "blueprints/application-foundations-and-navigation/breadcrumb-and-back-stack-workspace"))
                .appendChild(makeSubMenu("Command palette application", "blueprints/application-foundations-and-navigation/command-palette-application"))
                .appendChild(makeSubMenu("Multi-workspace application", "blueprints/application-foundations-and-navigation/multi-workspace-application"))
                .appendChild(makeSubMenu("Split-view navigation shell", "blueprints/application-foundations-and-navigation/split-view-navigation-shell"))
                .appendChild(makeSubMenu("Full-screen focused task shell", "blueprints/application-foundations-and-navigation/full-screen-focused-task-shell"))
            )
