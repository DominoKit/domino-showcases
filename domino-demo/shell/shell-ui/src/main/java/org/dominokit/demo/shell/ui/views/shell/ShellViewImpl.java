  ...
  private void addMenuItems() {
    menu
        ...
        .appendChild(TreeItem.create(Icons.view_dashboard(), "Blueprints")
            .apply(addToggleIcon())
            .appendChild(makeSubMenu("CRUD — short list / dialog editor", "blueprints/crud-short-dialog"))
            .appendChild(makeSubMenu("CRUD — short list / top form", "blueprints/crud-short-top-form"))
            .appendChild(makeSubMenu("CRUD — long list / dialog editor", "blueprints/crud-long-dialog"))
            .appendChild(makeSubMenu("CRUD — long list / side panel", "blueprints/crud-long-side-panel"))
            .appendChild(makeSubMenu("Search-first directory", "blueprints/search-directory"))
            .appendChild(makeSubMenu("Master-detail record workspace", "blueprints/record-workspace"))
            .appendChild(makeSubMenu("Long form with draft state", "blueprints/draft-form"))
            .appendChild(makeSubMenu("Approval request", "blueprints/approval-request"))
            .appendChild(makeSubMenu("Team work queue", "blueprints/team-queue"))
            .appendChild(makeSubMenu("KPI dashboard with drill-down", "blueprints/kpi-dashboard"))
            .appendChild(makeSubMenu("Resource scheduler", "blueprints/resource-scheduler"))
            .appendChild(makeSubMenu("Document library", "blueprints/document-library"))
            .appendChild(makeSubMenu("Import wizard", "blueprints/import-wizard"))
            .appendChild(makeSubMenu("Audit log explorer", "blueprints/audit-log"))
            .appendChild(makeSubMenu("Incident management workspace", "blueprints/incident-workspace"))
            .appendChild(makeSubMenu("Loading, empty, error, and permission states", "blueprints/special-states")))
