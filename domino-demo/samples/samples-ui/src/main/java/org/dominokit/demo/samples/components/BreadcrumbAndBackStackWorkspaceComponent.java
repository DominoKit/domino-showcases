...
@Component(
    modules = {
        BrixBreadcrumbAndBackStackWorkspacePresenterModule_.class,
        BrixBreadcrumbAndBackStackWorkspaceViewModule_.class,
        CoreComponentModule.class
    })
@Singleton
public interface BreadcrumbAndBackStackWorkspaceComponent
    extends IsBrixComponent, HasPresenterProvider<BreadcrumbAndBackStackWorkspacePresenterProvider> {

  ComponentProvider<BreadcrumbAndBackStackWorkspaceComponent> PROVIDER =
      new ComponentProvider<>() {
        @Override
        protected BreadcrumbAndBackStackWorkspaceComponent newInstance() {
          return DaggerBreadcrumbAndBackStackWorkspaceComponent.builder()
              .coreComponentModule(
